<template>
	<div class="like">
		{{msg}}
		<svg version="1.1" class="rocketManSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 600">
...
<script>
	...
	export default {
		...
		mounted: function() {
			var that = this;
			this.$root.$on('change', function(flag) {
				that.flag = flag;
			})
		},
		methods: {},
